...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    articlesSectionGrid: Schema.Attribute.Component<
      'shared.articles-section-grid',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featureStory: Schema.Attribute.Component<'shared.story-highlight', false>;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    FooterSection: Schema.Attribute.Component<'shared.footer-section', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::global.global'
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ChooseUsSection: Schema.Attribute.Component<'homepage.choose-us', true>;
    CommunitySection: Schema.Attribute.Component<'homepage.community', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
